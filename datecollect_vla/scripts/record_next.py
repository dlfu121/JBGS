...
# Dataset storage can live outside the repository (for example on a mounted
# USB disk).  Override it after moving the project with KEYCOLLECT_DATA_DIR;
# keep the historical mount as the default for backwards compatibility.
DATA_DIR = Path(os.environ.get("KEYCOLLECT_DATA_DIR", "/media/ee304/FDL")).expanduser()
